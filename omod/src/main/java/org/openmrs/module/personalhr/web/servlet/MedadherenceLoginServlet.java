 ...
 */
public class MedadherenceLoginServlet extends HttpServlet {
    
    public static final long serialVersionUID = 134231247523L;
    
    protected static final Log log = LogFactory.getLog(MedadherenceLoginServlet.class);
                ...
                if (Context.isAuthenticated()) {
                    ...
                    if("/openmrs".equals(redirect)) {
                        ...
                        if (PhrBasicRole.PHR_PATIENT.getValue().equals(phrRole)) {
                            if (personId != null) {
                                redirect = request.getContextPath() + "/module/medadherence/adherenceHome.form?patientId=" + personId;
