 ...
 */
public class phrForgotPasswordFormController extends SimpleFormController {
	
	/** Logger for this class and subclasses */
	protected static final Log log = LogFactory.getLog(phrForgotPasswordFormController.class);
