...
public class PhrUserFormController {
    ...
    public String handleSubmission(final WebRequest request, final HttpSession httpSession, final ModelMap model,
        ...
        if (!Context.isAuthenticated()) {
			...
			Context.addProxyPrivilege(OpenmrsConstants.PRIV_VIEW_ALLERGIES);
			
			Context.addProxyPrivilege(OpenmrsConstants.PRIV_ADD_PATIENT_PROGRAMS);
			Context.addProxyPrivilege(OpenmrsConstants.PRIV_EDIT_PATIENT_PROGRAMS);
			Context.addProxyPrivilege(OpenmrsConstants.PRIV_ADD_ALLERGIES);
			Context.addProxyPrivilege(OpenmrsConstants.PRIV_EDIT_ALLERGIES);
			Context.addProxyPrivilege(OpenmrsConstants.PRIV_DELETE_ALLERGIES);
			Context.addProxyPrivilege(OpenmrsConstants.PRIV_ADD_PROBLEMS);
			Context.addProxyPrivilege(OpenmrsConstants.PRIV_EDIT_PROBLEMS);
			Context.addProxyPrivilege(OpenmrsConstants.PRIV_DELETE_PROBLEMS);
			Context.addProxyPrivilege(OpenmrsConstants.PRIV_ADD_RELATIONSHIPS);
			Context.addProxyPrivilege(OpenmrsConstants.PRIV_EDIT_RELATIONSHIPS);
			Context.addProxyPrivilege(OpenmrsConstants.PRIV_DELETE_RELATIONSHIPS);
			Context.addProxyPrivilege(OpenmrsConstants.PRIV_EDIT_ORDERS);
			Context.addProxyPrivilege(OpenmrsConstants.PRIV_DELETE_ORDERS);
			Context.addProxyPrivilege("Manage Orders");
			Context.addProxyPrivilege("View Providers");
                ...
                if (isNewUser(user) && !isAdministrator) {
                    ...
                    if (token == null || token.getExpireDate().before(new Date())) {
                        ...
                        if (isTemporary) {
							...
							Context.removeProxyPrivilege(OpenmrsConstants.PRIV_ADD_PATIENT_PROGRAMS);
							Context.removeProxyPrivilege(OpenmrsConstants.PRIV_EDIT_PATIENT_PROGRAMS);
							Context.removeProxyPrivilege(OpenmrsConstants.PRIV_ADD_ALLERGIES);
							Context.removeProxyPrivilege(OpenmrsConstants.PRIV_EDIT_ALLERGIES);
							Context.removeProxyPrivilege(OpenmrsConstants.PRIV_DELETE_ALLERGIES);
							Context.removeProxyPrivilege(OpenmrsConstants.PRIV_ADD_PROBLEMS);
							Context.removeProxyPrivilege(OpenmrsConstants.PRIV_EDIT_PROBLEMS);
							Context.removeProxyPrivilege(OpenmrsConstants.PRIV_DELETE_PROBLEMS);
							Context.removeProxyPrivilege(OpenmrsConstants.PRIV_ADD_RELATIONSHIPS);
							Context.removeProxyPrivilege(OpenmrsConstants.PRIV_EDIT_RELATIONSHIPS);
							Context.removeProxyPrivilege(OpenmrsConstants.PRIV_DELETE_RELATIONSHIPS);
							Context.removeProxyPrivilege(OpenmrsConstants.PRIV_EDIT_ORDERS);
							Context.removeProxyPrivilege(OpenmrsConstants.PRIV_DELETE_ORDERS);
							Context.removeProxyPrivilege("Manage Orders");
