...
public class OrderListByPatientController extends SimpleFormController {
	...
	protected Object formBackingObject(HttpServletRequest request) throws ServletException {
		...
		if (Context.isAuthenticated()) {
			if (patientId != null) {
				// this is the default
				this.setFormView("/module/personalhr/view/orders/phrOrderListByPatient");
				...
				if (showAll) {
					this.setFormView("/module/personalhr/view/orders/phrOrderDrugList");
					OrderService os = Context.getOrderService();
					//orderList = os.getDrugOrders();
					orderList = os.getOrders(DrugOrder.class, null, null, ORDER_STATUS.ANY, null, null, null);
				} else {
					this.setFormView("/module/personalhr/view/orders/phrChoosePatient");
				}
			}
