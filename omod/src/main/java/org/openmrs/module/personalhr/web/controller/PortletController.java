    ...
    public ModelAndView handleRequest(final HttpServletRequest request, final HttpServletResponse response)
        ...
        try {
            ...
            
            {
                ...
                final String lastRequestId = (String) session.getAttribute(WebConstants.OPENMRS_PORTLET_LAST_REQ_ID);
                        ...
                        if (Context.hasPrivilege(OpenmrsConstants.PRIV_VIEW_PATIENTS)) {
                            ...
                            if (Context.hasPrivilege(OpenmrsConstants.PRIV_VIEW_OBS)) {
                                ...
                                try {
                                    ...
                                    if ((latestWeight != null) && (latestHeight != null)) {
                                        this.log.error("Failed to calculate BMI even though a weight and height were found",
                                            ex);
                                    }
                                }
                            ...
                            final String reasonForExitConceptString = as.getGlobalProperty("concept.reasonExitedCare");
                            ...
                            if (Context.hasPrivilege(OpenmrsConstants.PRIV_VIEW_ORDERS)) {
                                final List<DrugOrder> drugOrderList = Context.getOrderService().getDrugOrdersByPatient(p);
