...
<script type="text/javascript">
	...
	function click(obsId) {
		document.location = "${pageContext.request.contextPath}/phr/phrObs.form?obsId=" + obsId;
		return false;
	}
...
<c:if test="${encounter.encounterId != null}">
	...
	<div id="encounterFormAddObsMenu">
		<openmrs:hasPrivilege privilege="Add Observations">
			<div>
				<a href="${pageContext.request.contextPath}/phr/phrObs.form?encounterId=${encounter.encounterId}">
