...
<div id="patientPhrTabs${patientVariation}">
	...
	<personalhr:hasPrivilege privilege="View Overview">
	...
	<personalhr:hasPrivilege privilege="View Regimens">
	...
	<personalhr:hasPrivilege privilege="View Demographics">
...
<div id="patientSections">
		...
		<div id="patientOverview" style="display:none;">
			...
			<personalhr:portlet url="../module/personalhr/portlets/patientOverview.portlet" id="patientDashboardOverview" patientId="${patient.patientId}"/>
		</div>
		...
		<div id="patientRegimen" style="display:none;">
			...
			<personalhr:portlet url="../module/personalhr/portlets/patientRegimen.portlet" id="patientDashboardRegimen" patientId="${patient.patientId}" parameters="displayDrugSetIds=${displayDrugSetIds}" />	
		</div>
		...
		<div id="patientDemographics" style="display:none;">
			...
			<personalhr:portlet url="../module/personalhr/portlets/patientDemographics.portlet" id="patientDashboardDemographics" patientId="${patient.patientId}"/>		
		</div>	
