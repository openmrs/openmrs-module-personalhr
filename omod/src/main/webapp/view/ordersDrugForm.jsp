...
<openmrs:require privilege="Manage Orders" otherwise="/login.htm" redirect="/phr/orderDrug.form" />



<c:if test="${order.patient != null}">
	<a href="${pageContext.request.contextPath}/phr/patientDashboard.form?patientId=${order.patient.patientId}"><spring:message code="patientDashboard.viewDashboard"/></a>
</c:if>

<personalhr:hasPrivilege privilege="dodo">	
