...
<div id="patientActiveListProblemPortlet">
		...
		<c:forEach var="problem" items="${model.problems}">
			...
			<tr bgcolor="${bgColor}">
				...
				<personalhr:hasPrivilege privilege="Edittable Links">
					<a href="javascript:doEditProblem(${problem.activeListId});">
				</personalhr:hasPrivilege>
					<span id="problem_conceptName_${problem.activeListId}"><openmrs_tag:concept conceptId="${problem.problem.conceptId}"/></span>
					</a>
				</td>
				...
				<td>
				<personalhr:hasPrivilege privilege="Edittable Links">
					<a href="javascript:doResolveProblem(${problem.activeListId})"><img src="${pageContext.request.contextPath}/images/delete.gif" border="0" title="<spring:message code="ActiveLists.resolve"/>"/></a>
				</personalhr:hasPrivilege>
				</td>
			</tr>
		</c:forEach>
	...
	<div style="width: 100%">
	<personalhr:hasPrivilege privilege="Add Problems">
