								...
								<tr class='${status.index % 2 == 0 ? "evenRow" : "oddRow"}'>
									...
									<td class="encounterEdit" align="center">
										<c:if test="${showEditLink == 'true'}">
											<openmrs:hasPrivilege privilege="Edit Encounters">
												<c:set var="editUrl" value="${pageContext.request.contextPath}/phr/phrEncounter.form?encounterId=${enc.encounterId}"/>
									...
									<td class="encounterView" align="center">
										<c:if test="${showViewLink}">
											<c:set var="viewEncounterUrl" value="${pageContext.request.contextPath}/phr/phrEncounterDisplay.list?encounterId=${enc.encounterId}"/>
