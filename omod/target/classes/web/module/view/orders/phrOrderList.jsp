...
<a href="phrOrder.form"><spring:message code="Order.add"/></a> 
<a href="phrOrderDrugForm.form"><spring:message code="Order.drug.add"/></a><br />
		...
		<table id="orderTable" cellpadding="5" cellspacing="0">
			...
			<c:forEach var="order" items="${orderList}">
				<tr class="<c:if test="${order.voided}">voided </c:if>">
					...
					<td valign="top">
						<a href="phrOrder.form?orderId=${order.orderId}">
