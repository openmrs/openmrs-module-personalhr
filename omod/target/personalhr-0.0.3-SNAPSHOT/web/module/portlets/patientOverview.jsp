...
<c:if test="${not empty importantIdentifiers}">
	...
	<div id="patientIdentifiersBox" class="box${model.patientVariation}">
		<openmrs:portlet url="../module/personalhr/portlets/patientIdentifiers" size="normal" patientId="${model.patientId}" parameters="showIfSet=true|showIfMissing=true|highlightIfMissing=false" />
	</div>
	<p>
</c:if>

<personalhr:hasPrivilege privilege="View Programs">
	...
	<openmrs:portlet url="../module/personalhr/portlets/patientPrograms.portlet" id="patientPrograms" patientId="${patient.patientId}" parameters="allowEdits=true"/>
	</div>
	<br/>
</personalhr:hasPrivilege>

<personalhr:globalProperty var="conceptIdsToUse" key="dashboard.overview.showConcepts" />
...
<personalhr:hasPrivilege privilege="View Relationships">
	...
	<div id="patientRelationshipsBox" class="box${model.patientVariation}">
		<openmrs:portlet url="../module/personalhr/portlets/personRelationship.portlet" size="normal" patientId="${patient.patientId}" />
	</div>
	<br/>
</personalhr:hasPrivilege>


<personalhr:hasPrivilege privilege="View Allergies">
	...
	<div id="patientActiveListsAllergyBox" class="box${model.patientVariation}">
		<openmrs:portlet url="../module/personalhr/portlets/activeListAllergy.portlet" patientId="${patient.patientId}" parameters="type=allergy"/>
	</div>
	<br/>
</personalhr:hasPrivilege>

<personalhr:hasPrivilege privilege="View Problems">
	...
	<div id="patientActiveListsProblemBox" class="box${model.patientVariation}">
		<openmrs:portlet url="../module/personalhr/portlets/activeListProblem.portlet" patientId="${patient.patientId}" parameters="type=problem"/>
	</div>
	<br/>
</personalhr:hasPrivilege>