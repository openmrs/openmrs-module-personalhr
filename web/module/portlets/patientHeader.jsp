...
--%>
	...
	<c:if test="${not empty model.patientReasonForExit}">
		...
		<table id="patientHeaderGeneralInfo">
			<tr class="patientHeaderGeneralInfoRow">
				...
				<personalhr:globalProperty key="use_patient_attribute.healthCenter" defaultValue="false" var="showHealthCenter"/>
				<c:if test="${showHealthCenter && not empty model.patient.attributeMap['Health Center']}">
					<td id="patientHeaderHealthCenter">
						...
						<b>${model.patient.attributeMap['Health Center']}</b>
					</td>
				</c:if>
	...
	<c:if test="${not empty model.patientReasonForExit}">
		...
		<personalhr:globalProperty var="programIdsToShow" key="dashboard.header.programs_to_show" listSeparator=","/>
		<%--
		...
		--%>
		<personalhr:globalProperty var="workflowsToShow" key="dashboard.header.workflows_to_show"/>
		...
		<table id="patientHeaderObs">
			<personalhr:globalProperty key="concept.weight" var="weightConceptId"/>
			<personalhr:globalProperty key="concept.height" var="heightConceptId"/>
			<personalhr:globalProperty key="concept.cd4_count" var="cd4ConceptId"/>
